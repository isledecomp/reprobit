...
they are not committed. This example pins both installations to ReproBit `0.1.6`:
    ...
    steps:
      ...
      - name: Install the pinned ReproBit CLI for provisioning
        run: >-
          ...
          "git+https://github.com/isledecomp/reprobit.git@0.1.6"
      - name: Provision and authenticate MSVC 4.2
        run: >-
          ...
          --no-save
      - id: reprobit
        uses: isledecomp/reprobit@0.1.6
        with:
          project-directory: .
